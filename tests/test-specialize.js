      ...
      specialize(new ReaperBase({
        ...
        contents: [
          ...
          new ReaperAudioSource({
            ...
            params: ['WAVE'],
            contents: [
              { token: 'FILE', params: [path.join(__dirname, '../rpp-examples/media/909-kick.wav')] }
            ]
          })
        ]
  ...
  describe('plugins', function () {
    it('should add a VST to FXCHAIN objects', function () {
      specialize(new ReaperBase({
        ...
        b64Chunks: ['oTMVd+9e7f4CAAAAAQAAAAAAAAACAAAAAAAAAAIAAAABAAAAAAAAAAIAAAAAAAAAEgUAAAEAAAD//xAA',
    ...
    }) // It should add a vst to FXCHAIN objects
...
`<FXCHAIN
  ...
  WAK 0 0
>`)
    }) // it should dump fx chain objects
  }) // describe plugins
